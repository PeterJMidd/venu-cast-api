...
SESSION_STATE = {
    ...
    # ── PROPHET SOFTENING — shrink extreme predictions toward FY26 baseline ──
    # Applied AFTER Prophet but BEFORE guardrails/cannibalisation/LFL.
    # beta = 1.0 → no softening (raw Prophet)
    # beta = 0.7 → 70% Prophet + 30% recent baseline (default)
    # beta = 0.5 → equal blend (heavier softening)
    'softening_settings': {'enabled': True, 'beta': 0.7},
    # ── VENUE-MONTH ADJUSTMENTS (view-time scenario overlay, FY27 only) ──
    # { venue_name: { 'YYYY-MM': { 'adjustment_type': 'growth'|'cannibalisation', 'value_pct': float } } }
    # growth: replaces the month's LFL with the specified percentage
    # cannibalisation: adds/subtracts from the month's LFL (e.g., 5% + -10% = -5%)
    'venue_month_adjustments': {},
}
...
SCHOOL_HOLIDAY_CACHE = {}  # state -> set of date_strs in school holidays


# ── AUSTRALIAN SCHOOL HOLIDAYS (Government / Public schools) ──────────────────
# Approximate term-break date ranges per state for 2024–2028 (inclusive both ends).
# Sourced from publicly published education department calendars (NSW, VIC, QLD,
# SA, WA, TAS, ACT, NT). Used both as a Prophet regressor for mature venues and
# as a multiplicative lift inside DOW-Flat for new venues.
# Australian state school holidays — 2024-2028, all 8 states (NSW, VIC, QLD, SA, WA, TAS, ACT, NT).
# Sources: state Department of Education sites cross-verified with publicholidays.com.au,
# qldschoolholiday.com.au, schoolholidayssa.com.au, schoolholidayswa.com.au, tasmanianschoolholidays.com.au,
# actschoolholidays.com.au, ntschoolholidays.com.au. NSW dates use the Eastern division (the bulk of
# Yo-Chi venues sit in the eastern catchment); Western-division summer extends ~1 week longer.
#
# Confidence: 2024 high (historical, published). 2025 high (most current). 2026 high (official current-year
# calendars). 2027 high for SA/ACT/NT/TAS/NSW/VIC (officially published), medium for QLD/WA (draft).
# 2028 mostly extrapolated — flagged inline where extrapolated. Year-on-year date shifts ARE
# captured (e.g. Easter shifting 5 March → late April changes the autumn-break dates) — Prophet
# will learn the calendar-position effect from history, not a fixed week-number.
SCHOOL_HOLIDAY_RANGES = {
    'NSW': [
        ('2024-04-15', '2024-04-26'), ('2024-07-08', '2024-07-19'),
        ('2024-09-30', '2024-10-11'), ('2024-12-23', '2025-01-30'),
        ('2025-04-14', '2025-04-24'), ('2025-07-07', '2025-07-18'),
        ('2025-09-29', '2025-10-10'), ('2025-12-22', '2026-01-26'),
        ('2026-04-13', '2026-04-24'), ('2026-07-06', '2026-07-17'),
        ('2026-09-28', '2026-10-09'), ('2026-12-21', '2027-01-29'),
        ('2027-04-12', '2027-04-23'), ('2027-07-05', '2027-07-16'),
        ('2027-09-27', '2027-10-08'), ('2027-12-21', '2028-01-28'),
        ('2028-04-10', '2028-04-21'), ('2028-07-10', '2028-07-21'),
        ('2028-10-03', '2028-10-13'), ('2028-12-22', '2029-01-25'),
    ],
    'VIC': [
        ('2024-03-29', '2024-04-14'), ('2024-06-29', '2024-07-14'),
        ('2024-09-21', '2024-10-06'), ('2024-12-21', '2025-01-27'),
        ('2025-04-05', '2025-04-21'), ('2025-07-05', '2025-07-20'),
        ('2025-09-20', '2025-10-05'), ('2025-12-20', '2026-01-26'),
        ('2026-04-03', '2026-04-19'), ('2026-06-29', '2026-07-10'),
        ('2026-09-19', '2026-10-04'), ('2026-12-19', '2027-01-26'),
        ('2027-03-26', '2027-04-11'), ('2027-06-26', '2027-07-11'),
        ('2027-09-18', '2027-10-03'), ('2027-12-18', '2028-01-26'),
        ('2028-04-01', '2028-04-17'), ('2028-07-01', '2028-07-16'),
        ('2028-09-23', '2028-10-08'), ('2028-12-22', '2029-01-25'),
    ],
    'QLD': [
        ('2024-03-29', '2024-04-14'), ('2024-06-22', '2024-07-07'),
        ('2024-09-14', '2024-09-29'), ('2024-12-14', '2025-01-27'),
        ('2025-04-05', '2025-04-21'), ('2025-06-28', '2025-07-13'),
        ('2025-09-20', '2025-10-06'), ('2025-12-13', '2026-01-26'),
        ('2026-04-03', '2026-04-19'), ('2026-06-27', '2026-07-12'),
        ('2026-09-19', '2026-10-05'), ('2026-12-12', '2027-01-26'),
        ('2027-03-26', '2027-04-11'), ('2027-06-26', '2027-07-11'),
        ('2027-09-18', '2027-10-04'), ('2027-12-11', '2028-01-23'),
        ('2028-04-01', '2028-04-17'), ('2028-06-24', '2028-07-09'),
        ('2028-09-16', '2028-10-02'), ('2028-12-09', '2029-01-21'),
    ],
    'SA': [
        ('2024-04-13', '2024-04-28'), ('2024-07-06', '2024-07-21'),
        ('2024-09-28', '2024-10-13'), ('2024-12-14', '2025-01-27'),
        ('2025-04-12', '2025-04-27'), ('2025-07-05', '2025-07-20'),
        ('2025-09-27', '2025-10-12'), ('2025-12-13', '2026-01-26'),
        ('2026-04-11', '2026-04-26'), ('2026-07-04', '2026-07-19'),
        ('2026-09-26', '2026-10-11'), ('2026-12-12', '2027-01-26'),
        ('2027-04-10', '2027-04-25'), ('2027-07-03', '2027-07-18'),
        ('2027-09-25', '2027-10-10'), ('2027-12-11', '2028-01-30'),
        ('2028-04-14', '2028-04-30'), ('2028-07-08', '2028-07-23'),
        ('2028-09-30', '2028-10-15'), ('2028-12-16', '2029-01-29'),
    ],
    'WA': [
        ('2024-03-29', '2024-04-14'), ('2024-06-29', '2024-07-14'),
        ('2024-09-21', '2024-10-06'), ('2024-12-13', '2025-02-04'),
        ('2025-04-12', '2025-04-27'), ('2025-07-05', '2025-07-20'),
        ('2025-09-27', '2025-10-12'), ('2025-12-19', '2026-02-01'),
        ('2026-04-03', '2026-04-19'), ('2026-07-04', '2026-07-19'),
        ('2026-09-26', '2026-10-11'), ('2026-12-18', '2027-01-31'),
        ('2027-04-10', '2027-04-25'), ('2027-07-03', '2027-07-18'),
        ('2027-09-25', '2027-10-10'), ('2027-12-17', '2028-02-01'),
        ('2028-04-08', '2028-04-23'), ('2028-07-01', '2028-07-16'),
        ('2028-09-23', '2028-10-08'), ('2028-12-15', '2029-01-30'),
    ],
    'TAS': [
        ('2024-04-12', '2024-04-28'), ('2024-07-06', '2024-07-21'),
        ('2024-09-28', '2024-10-13'), ('2024-12-20', '2025-02-04'),
        ('2025-04-12', '2025-04-27'), ('2025-07-05', '2025-07-20'),
        ('2025-09-27', '2025-10-12'), ('2025-12-19', '2026-02-04'),
        ('2026-04-18', '2026-05-03'), ('2026-07-11', '2026-07-26'),
        ('2026-10-03', '2026-10-18'), ('2026-12-19', '2027-02-03'),
        ('2027-04-10', '2027-04-25'), ('2027-07-03', '2027-07-18'),
        ('2027-09-25', '2027-10-10'), ('2027-12-17', '2028-02-02'),
        ('2028-04-15', '2028-04-30'), ('2028-07-08', '2028-07-23'),
        ('2028-09-30', '2028-10-15'), ('2028-12-22', '2029-02-07'),
    ],
    'ACT': [
        ('2024-04-13', '2024-04-28'), ('2024-07-06', '2024-07-21'),
        ('2024-09-28', '2024-10-13'), ('2024-12-18', '2025-02-02'),
        ('2025-04-12', '2025-04-28'), ('2025-07-05', '2025-07-21'),
        ('2025-09-27', '2025-10-13'), ('2025-12-19', '2026-02-01'),
        ('2026-04-03', '2026-04-20'), ('2026-07-04', '2026-07-20'),
        ('2026-09-26', '2026-10-12'), ('2026-12-19', '2027-01-31'),
        ('2027-04-10', '2027-04-27'), ('2027-07-03', '2027-07-19'),
        ('2027-09-25', '2027-10-11'), ('2027-12-18', '2028-02-06'),
        ('2028-04-08', '2028-04-25'), ('2028-07-08', '2028-07-24'),
        ('2028-09-30', '2028-10-16'), ('2028-12-23', '2029-02-04'),
    ],
    'NT': [
        ('2024-04-06', '2024-04-14'), ('2024-06-22', '2024-07-15'),
        ('2024-09-21', '2024-10-06'), ('2024-12-14', '2025-01-28'),
        ('2025-04-05', '2025-04-13'), ('2025-06-21', '2025-07-14'),
        ('2025-09-20', '2025-10-05'), ('2025-12-13', '2026-01-27'),
        ('2026-04-03', '2026-04-13'), ('2026-06-20', '2026-07-13'),
        ('2026-09-19', '2026-10-05'), ('2026-12-11', '2027-01-26'),
        ('2027-04-03', '2027-04-12'), ('2027-06-19', '2027-07-12'),
        ('2027-09-18', '2027-10-04'), ('2027-12-10', '2028-01-24'),
        ('2028-04-08', '2028-04-18'), ('2028-06-24', '2028-07-17'),
        ('2028-09-23', '2028-10-09'), ('2028-12-15', '2029-01-28'),
    ],
}


def load_school_holidays_for_state(state):
    """Return a SET of YYYY-MM-DD strings that fall within school holidays for state."""
    if not state:
        return set()
    if state in SCHOOL_HOLIDAY_CACHE:
        return SCHOOL_HOLIDAY_CACHE[state]
    ranges = SCHOOL_HOLIDAY_RANGES.get(state, [])
    dates = set()
    ...
    SCHOOL_HOLIDAY_CACHE[state] = dates
    log.info(f"  Loaded {len(dates)} school-holiday days for {state}")
    return dates
...
def analyse_venue_history(dates, values):
    ...
    # Bypass Prophet for venues with < 90 trading days. With only 1-3 months of
    # actuals, Prophet's trend over-extrapolates small recent dips into permanent
    # declines (the Indooroopilly/Kawana pattern where Prophet projected zero
    # sales by month 4). DOW-Flat uses recent_mean × weekday pattern instead.
    bypass_prophet = n_trading < 90
...
def _compute_peer_seasonality(venue):
    """Compute monthly seasonal index borrowed from mature peer venues.
    Returns dict {month: index} where index is monthly_avg / annual_avg.
    Index of 1.0 = monthly average. >1 = peak, <1 = trough.

    Peers: same cluster (preferred); else same state; with ≥365 trading days.
    """
    loc_bi = SESSION_STATE.get('location_bi') or {}
    servings = SESSION_STATE.get('sales_servings') or {}
    me = loc_bi.get(venue, {}) or {}
    my_cluster = me.get('cluster')
    my_state = get_venue_state(venue) or ''

    # Find peers
    peers = []
    for v, info in loc_bi.items():
        if v == venue or v not in servings:
            continue
        n_trading = sum(1 for x in servings[v].values() if x and x > 0)
        if n_trading < 365:
            continue
        peer_cluster = (info or {}).get('cluster')
        if my_cluster and peer_cluster == my_cluster:
            peers.append((v, 2))   # cluster match — weight 2
        elif my_state and get_venue_state(v) == my_state:
            peers.append((v, 1))   # state-only match — weight 1
    if not peers and my_state:
        # Last resort: all mature venues in same state
        peers = [(v, 1) for v in servings.keys()
                 if v != venue and sum(1 for x in servings[v].values() if x and x > 0) >= 365
                 and get_venue_state(v) == my_state]

    if not peers:
        return {m: 1.0 for m in range(1, 13)}   # neutral fallback

    # Compute each peer's monthly index, weighted average
    monthly_sums = {m: 0.0 for m in range(1, 13)}
    weight_sums = {m: 0.0 for m in range(1, 13)}
    for v, w in peers:
        monthly_totals = {m: 0.0 for m in range(1, 13)}
        monthly_count = {m: 0 for m in range(1, 13)}
        for d_str, val in servings[v].items():
            if not val or val <= 0:
                continue
            try:
                ...
                continue
            monthly_totals[d.month] += val
            monthly_count[d.month] += 1
        monthly_avg = {m: (monthly_totals[m] / monthly_count[m]) if monthly_count[m] else 0
                       for m in range(1, 13)}
        annual_avg = (sum(monthly_avg.values()) / 12) if any(monthly_avg.values()) else 1
        if annual_avg <= 0:
            continue
        for m in range(1, 13):
            if monthly_avg[m] > 0:
                monthly_sums[m] += (monthly_avg[m] / annual_avg) * w
                weight_sums[m] += w

    return {m: (monthly_sums[m] / weight_sums[m]) if weight_sums[m] > 0 else 1.0
            for m in range(1, 13)}


def dow_flat_forecast(analysis, h, last_date_str, venue=None, state=None,
                      holiday_map=None, school_holiday_dates=None,
                      public_holiday_lift=1.20, school_holiday_lift=1.18):
    """DOW-flat + peer-borrowed seasonality + holiday & school-holiday lifts.
    Used for new venues (<90 days) where Prophet can't learn the holiday effect
    from history. Applies:
      • Monthly seasonal index borrowed from mature peer venues in same cluster/state
      • Public holiday lift (default +20%)
      • School holiday lift (default +18% on weekdays, slightly more on Mon-Fri)
    The +18% reflects a STRONG kids-out-of-school + warmer-weather lift typically
    observed at Yo-Chi network mature venues (Prophet learns the exact figure for
    mature venues; this fallback applies only to brand-new venues).
    The lift compounds: school holidays falling on a public holiday get BOTH lifts.
    Spring & autumn breaks (warmer weather + outdoor) get an extra +5% boost over
    winter school holidays. No trend extrapolation — preserves stability for
    ramping venues.
    """
    dow_means = analysis["dow_means"] or {}
    recent = analysis["recent_mean"]
    recent_max = analysis["recent_max"]
    ceiling = max(recent_max * 1.8, recent * 2.5, 1.0)   # slightly more generous to allow seasonal peaks

    # Peer seasonality (monthly index)
    peer_seasonality = _compute_peer_seasonality(venue) if venue else {m: 1.0 for m in range(1, 13)}
    if holiday_map is None: holiday_map = {}
    if school_holiday_dates is None: school_holiday_dates = set()
    ...
    for i in range(h):
        ...
        # Monthly seasonality
        base = base * peer_seasonality.get(d.month, 1.0)

        # Public holiday lift (compounds with school holiday)
        if d_str in holiday_map:
            base = base * public_holiday_lift
        # School holiday lift — warmer-weather breaks (Apr/Sep/Oct/summer) get
        # extra boost vs winter (July) break.
        if d_str in school_holiday_dates:
            warm_month = d.month in (1, 4, 9, 10, 12)
            lift = school_holiday_lift * (1.05 if warm_month else 1.0)
            base = base * lift
    ...
    rmse = 0.0
    parts = ["DOW-Flat"]
    if any(abs(v - 1.0) > 0.05 for v in peer_seasonality.values()):
        parts.append("PeerSeas")
    if holiday_map:    parts.append("PubHol")
    if school_holiday_dates: parts.append("SchHol")
    label = "+".join(parts)
    return fitted, fc_out, lo_out, hi_out, rmse, label
...
def sanitise_forecast(fc, lo, hi, analysis):
    ...
    # forecast below 40% of its recent average for any single day.
    # Applied ONLY for venues with 365+ trading days (full year of history). For
    # sub-365 venues, the per-day floor was clipping legitimate winter / off-season
    # dips and FLATTENING the peer-borrowed seasonality overlay. Those venues
    # instead rely on the post-resolution baseline guardrails to keep totals sane.
    floor = 0.0
    if n_trade >= 365 and recent > 0:
        floor = recent * 0.40
...
def run_prophet(dates, values, h, holiday_dates=None, holiday_names=None, weather_map=None):
    ...
    if n_trading < 30:
        ...
        # 90-179 trading days — venue has 3-6 months of trading.
        # Use a NEAR-FLAT trend (changepoint=0.001) so Prophet doesn't extrapolate
        # short-term momentum (e.g. Chippendale-style ramp-up) into runaway growth
        # or recent dips into permanent decline.
        params = dict(yearly_seasonality=False, weekly_seasonality=True,
                      changepoint_prior_scale=0.001, seasonality_prior_scale=5, n_changepoints=2)
    elif n_trading < 365:
        # 180-364 trading days — venue has ~6-12 months of trading.
        # KEEP TREND FLAT (changepoint=0.003) so Prophet doesn't extrapolate
        # recent ramps or dips into runaway shapes that the peer-seasonality
        # overlay then amplifies (the Castle-Towers $0-November pathology).
        # yearly_seasonality still off — peer overlay supplies the annual shape.
        params = dict(yearly_seasonality=False, weekly_seasonality=True,
                      changepoint_prior_scale=0.003, seasonality_prior_scale=5, n_changepoints=4)
    else:
        # Full Prophet: yearly seasonality enabled.
        # - Tight trend (changepoint_prior_scale=0.010) so a recent dip can't become
        #   a "permanent" downward trend (the Cronulla/Gouger pathology).
        # - STRONG seasonality (prior 30) + 12 Fourier terms for yearly so
        #   beachy/holiday-driven venues show real summer peaks and winter troughs.
        # - changepoint_range=0.85 — only place changepoints in the first 85% of
        #   history; the last 15% (the recent dip) does not redefine the trend.
        params = dict(
            yearly_seasonality=12,           # 12 Fourier terms — captures detailed within-year shape
            weekly_seasonality=True,
            changepoint_prior_scale=0.010,
            seasonality_prior_scale=30,      # higher → more freedom for seasonal swings
            n_changepoints=15,
    ...
    # Build descriptive label — make school-holiday inclusion EXPLICIT so dashboard shows it.
    has_sch = bool(holiday_names) and any('school_holiday' in n for n in holiday_names)
    has_pub = bool(holiday_names) and any('school_holiday' not in n and n != 'user_holiday' for n in holiday_names)
    parts = ["Prophet"]
    if use_wx: parts.append("Wx")
    if has_pub: parts.append("PubHol")
    if has_sch: parts.append("SchHol")
    return fi, fc, lo, hi, rmse, "+".join(parts)
...
def forecast_engine(dates, values, h, holiday_dates=None, holiday_names=None, weather_map=None,
                    analysis=None, venue=None, state=None, school_holiday_dates=None):
    ...
    New venues (<90 trading days) get DOW-Flat with peer-borrowed monthly seasonality
    + public-holiday + school-holiday lifts.
    """
    if analysis is None:
        analysis = analyse_venue_history(dates, values)

    # Build holiday map from dates+names (for DOW-flat lookup)
    holiday_map = {}
    if holiday_dates:
        for i, d in enumerate(holiday_dates):
            name = holiday_names[i] if holiday_names and i < len(holiday_names) else 'public_holiday'
            holiday_map[d] = name

    # Sub-90-trading-days venues: bypass Prophet entirely
    if analysis['bypass_prophet']:
        fi, fc, lo, hi, rmse, label = dow_flat_forecast(
            analysis, h, dates[-1],
            venue=venue, state=state,
            holiday_map=holiday_map,
            school_holiday_dates=school_holiday_dates or set(),
        )
        fc, lo, hi, n_clamped = sanitise_forecast(fc, lo, hi, analysis)
        return fi, fc, lo, hi, rmse, f"{label} (new<90d)"
    ...
    # ── PEER-SEASONALITY OVERLAY for sub-365-day venues ──
    # Prophet's yearly seasonality only fires reliably with 365+ days of history.
    # Venues with 90-364 trading days (e.g. Chippendale, Castle Towers, Bondi Junction)
    # get yearly_seasonality=False → flat shape. Overlay peer-borrowed monthly index
    # so they inherit the cluster/state seasonal pattern (Jan summer peak,
    # Easter lift, Aug winter trough, etc.).
    #
    # IMPORTANT — implementation is *monthly-rescale*, NOT daily-multiply:
    #   1. Compute Prophet's current monthly totals for the forecast horizon
    #   2. Compute target monthly totals from peer seasonality (CLAMPED 0.65-1.35
    #      so a single freaky peer can't drive zero or runaway months)
    #   3. Enforce a MONTHLY FLOOR (35% of the avg monthly) so no calendar month
    #      can collapse to $0 even if Prophet's trend goes sideways
    #   4. Rescale target totals so they sum to Prophet's annual total (preserves
    #      the overall level — the overlay only RESHAPES, never inflates/shrinks)
    #   5. Apply a per-month uniform scalar to Prophet's daily values
    # This preserves Prophet's within-month texture (weekly DOW pattern, weather,
    # holiday lifts) while forcing monthly proportions to match the peer pattern.
    if venue and analysis['n_trading'] < 365:
        try:
            peer_seas = _compute_peer_seasonality(venue)
        except Exception:
            peer_seas = None
        if peer_seas and any(abs(v - 1.0) > 0.05 for v in peer_seas.values()):
            last_d = datetime.strptime(dates[-1], "%Y-%m-%d")
            seas_avg = sum(peer_seas.values()) / 12.0 if peer_seas else 1.0
            if seas_avg > 0:
                # Normalise peer index, then CLAMP to a sensible range so a freaky
                # peer (e.g. Cronulla post-COVID step) can't drive an extreme month.
                normalised = {m: max(0.65, min(1.35, v / seas_avg))
                              for m, v in peer_seas.items()}

                # Bucket forecast indices by (year, month)
                month_indices = {}
                month_totals = {}
                ...
                annual_total = sum(month_totals.values())
                total_days = sum(len(idxs) for idxs in month_indices.values())
                if annual_total > 0 and total_days > 0:
                    avg_per_day = annual_total / total_days

                    # Target monthly totals = avg_per_day × seas_mult × days_in_month
                    target_totals = {}
                    for key, idxs in month_indices.items():
                        m = key[1]
                        seas_mult = normalised.get(m, 1.0)
                        target_totals[key] = avg_per_day * seas_mult * len(idxs)

                    # Rescale so SUM(target_totals) == annual_total
                    target_sum = sum(target_totals.values())
                    if target_sum > 0:
                        rescale = annual_total / target_sum
                        for key in target_totals:
                            target_totals[key] *= rescale

                    # Monthly FLOOR — no month can fall below 35% of avg monthly.
                    # Stops Prophet's trend pathology producing $0 months.
                    n_months = len(month_totals)
                    avg_monthly = annual_total / n_months if n_months else 0
                    monthly_floor = avg_monthly * 0.35
                    for key in target_totals:
                        if target_totals[key] < monthly_floor:
                            target_totals[key] = monthly_floor

                    # Apply per-month uniform scalar to daily forecast
                    fc_overlaid = list(fc)
                    lo_overlaid = list(lo)
                    hi_overlaid = list(hi)
                    for key, idxs in month_indices.items():
                        current = month_totals[key]
                        target = target_totals[key]
                        if current > 0.01:
                            scale = target / current
                            for i in idxs:
                                fc_overlaid[i] = fc[i] * scale
                                lo_overlaid[i] = lo[i] * scale
                                hi_overlaid[i] = hi[i] * scale
                        else:
                            # Prophet gave ~$0 for the whole month — bootstrap a
                            # flat daily value from the target.
                            per_day = target / len(idxs) if idxs else 0
                            for i in idxs:
                                fc_overlaid[i] = per_day
                                lo_overlaid[i] = per_day * 0.80
                                hi_overlaid[i] = per_day * 1.20

                    fc, lo, hi = fc_overlaid, lo_overlaid, hi_overlaid
                    model_used = f"{model_used}+PeerSeas"
...
def _compute_secondary_stream_ratios(venue):
    """Return (retail_ratio, discount_ratio) — multipliers to apply to a venue's
    servings forecast to derive Retail and POS Discount streams.

    Used for FY27 NEW OPENINGS that have no history. The template only supplies
    a 'new_monthly_sales' figure (treated as Servings). We need separate Retail
    and Discounts streams so the dashboard Sales Type dropdown shows realistic
    values across all three streams.

    Strategy: take mature peers (≥365 trading days) with positive servings + at
    least some retail. Compute peer-level Retail/Servings and abs(Discounts)/Servings
    ratios. Weighted average — cluster peers weight 2, state peers weight 1.
    Falls back to network averages if cluster/state has no qualifying peers.
    """
    loc_bi = SESSION_STATE.get('location_bi') or {}
    servings = SESSION_STATE.get('sales_servings') or {}
    ...
    network_r_sum = 0.0
    network_d_sum = 0.0
    network_serv_sum = 0.0

    for v in servings.keys():
        if v == venue:
            continue
        vs_tot = sum(x for x in servings[v].values() if x and x > 0)
        n_trade = sum(1 for x in servings[v].values() if x and x > 0)
        if vs_tot <= 0 or n_trade < 365:
            continue
        vr_tot = sum(x for x in (retail.get(v) or {}).values() if x and x > 0)
        vd_tot = sum(abs(x) for x in (discounts.get(v) or {}).values() if x is not None)
        r_ratio = vr_tot / vs_tot if vs_tot > 0 else 0
        d_ratio = vd_tot / vs_tot if vs_tot > 0 else 0
        # Network accumulation
        network_serv_sum += vs_tot
        network_r_sum += vr_tot
        network_d_sum += vd_tot
        # Cluster/state weighting
        peer_cluster = (loc_bi.get(v) or {}).get('cluster')
        peer_state = get_venue_state(v) or ''
        if my_cluster and peer_cluster == my_cluster:
            w = 2.0
        elif my_state and peer_state == my_state:
            w = 1.0
        else:
            continue
        weighted_r_sum += r_ratio * w
        weighted_d_sum += d_ratio * w
        weight_sum += w

    if weight_sum > 0:
        return (weighted_r_sum / weight_sum, weighted_d_sum / weight_sum)
    if network_serv_sum > 0:
        return (network_r_sum / network_serv_sum, network_d_sum / network_serv_sum)
    return (0.0, 0.0)   # last-resort: leave at zero
...
def forecast_venue(venue, sales_series, atp_history, extra_holiday_dates=None):
    ...
    if state:
        ...
        school_holiday_dates = load_school_holidays_for_state(state)
    ...
    if not sales_series:
        if venue_details and venue_details.get('new_monthly_sales', 0) > 0:
            ...
            fc_school_holidays = [1 if d in school_holiday_dates else 0 for d in dates_window]
            return {
                'venue': venue,
                'state': state or '',
                'model': model_used,
                ...
                'school_holiday_days': fc_school_holidays,
                'school_holiday_count': sum(fc_school_holidays),
                'school_holidays_loaded_count': len(school_holiday_dates),
    ...
    # Combine state public holidays + school holidays + any user-supplied.
    # School holidays are split into FOUR named categories (autumn/winter/spring/summer)
    # so Prophet learns separate coefficients per season — kids out of school on a warm
    # April day has a much bigger Yo-Chi impact than a cold July day. This lets the
    # year-on-year date SHIFTS (Easter moves between March and late April) carry the
    # correct lift forward to the FY27 forecast period.
    def _school_holiday_label(d_str):
        try:
            m = int(d_str[5:7])
        except Exception:
            return "school_holiday"
        if m in (3, 4, 5):   return "school_holiday_autumn"   # Easter / autumn break
        if m in (6, 7):      return "school_holiday_winter"   # July break (cold)
        if m in (8, 9, 10):  return "school_holiday_spring"   # spring break (warming up)
        return "school_holiday_summer"                          # Dec/Jan/Feb (peak yoghurt)

    all_holiday_dates = list(state_holidays_map.keys())
    all_holiday_names = [state_holidays_map[d] for d in all_holiday_dates]
    for d in school_holiday_dates:
        if d not in state_holidays_map:
            all_holiday_dates.append(d)
            all_holiday_names.append(_school_holiday_label(d))
    if extra_holiday_dates:
        for d in extra_holiday_dates:
            if d not in state_holidays_map and d not in school_holiday_dates:
                all_holiday_dates.append(d)
    ...
    fc_holidays = [state_holidays_map.get(d, '') for d in dates_window]
    fc_school_holidays = [1 if d in school_holiday_dates else 0 for d in dates_window]
    sch_days_in_horizon = sum(fc_school_holidays)
    ...
    return {
        ...
        'holiday_names': fc_holidays,
        'school_holiday_days': fc_school_holidays,
        'school_holiday_count': sch_days_in_horizon,
        'school_holidays_loaded_count': len(school_holiday_dates),
        'holidays_loaded_count': len(state_holidays_map),
        'weather_days_loaded': len(weather_map),
    }
        ...
        try:
            ...
            combined = {
                ...
                'servings': {
                    ...
                    # Pipe through holiday-coverage metadata so /venues-detail can surface it.
                    'school_holidays_loaded_count': servings_result.get('school_holidays_loaded_count', 0),
                    'school_holiday_count': servings_result.get('school_holiday_count', 0),
                    'holidays_loaded_count': servings_result.get('holidays_loaded_count', 0),
                },
                ...
                'school_holiday_days': servings_result.get('school_holiday_days', []),
                'data_sources': {
                    'state_holidays_loaded': servings_result.get('holidays_loaded_count', 0),
                    'school_holidays_loaded': servings_result.get('school_holidays_loaded_count', 0),
                    'school_holiday_days_in_forecast': servings_result.get('school_holiday_count', 0),
            ...
            # ── Derive Retail + Discounts for venues with NO history of their own ──
            # (mostly FY27 New Openings). Without this, the dashboard's Sales Type
            # dropdown shows $0 for retail/discounts on new stores, which makes the
            # FY27 forecast look identical across all sales types. We apply cluster-
            # peer ratios so the new venue inherits realistic Retail/Servings and
            # Discounts/Servings proportions from comparable mature stores.
            if 'retail' not in combined or 'discounts' not in combined:
                r_ratio, d_ratio = _compute_secondary_stream_ratios(venue)
                servings_sales = combined['servings']['sales']
                if 'retail' not in combined and r_ratio > 0:
                    combined['retail'] = {
                        'model': f'Servings×{r_ratio:.3f} (peer-derived)',
                        'sales': [round(s * r_ratio, 2) for s in servings_sales],
                    }
                if 'discounts' not in combined and d_ratio > 0:
                    combined['discounts'] = {
                        'model': f'Servings×{d_ratio:.3f} (peer-derived)',
                        'sales': [round(-(s * d_ratio), 2) for s in servings_sales],
                    }
...
def sales_detail():
    ...
    # Universal LFL pre-pass — target is sized on the CURRENTLY VIEWED sales_type
    # so the user sees exactly their target % on whichever view they're looking at.
    lfl_multipliers, lfl_summary = _build_universal_lfl_multipliers(
        results, apply_guards, apply_cann, sales_type=sales_type
    )
    ...
    def forecast_for(r):
        ...
        Resolution priority: scenario → cannibalisation → guardrails → universal LFL (NET-based) → venue-month adjustments.
        ...
        # Apply venue-month adjustments (view-time scenario overlay)
        (serv, ret, disc), _vma_note = _apply_venue_month_adjustments_streams(r, serv, ret, disc)
        if sales_type == 'servings':
            return serv
        if sales_type == 'retail':
            return ret
    ...
    def forecast_base_for(r):
        ...
        # Apply venue-month adjustments (view-time scenario overlay)
        (serv_resolved, ret, disc), _ = _apply_venue_month_adjustments_streams(r, serv_resolved, ret, disc)
    ...
    # ── EVENT AGGREGATION: public holidays + school holidays + extreme weather per month/FY ──
    ...
    school_fy26  = {m: {} for m in range(1, 13)}    # month -> {date_str: [states]}
    school_fy27  = {m: {} for m in range(1, 13)}
    ...
    for s in states_in_filter:
        ...
        # School holidays (resolve via the state's loaded school-holiday set)
        sch_set = load_school_holidays_for_state(s)
        for d_str in sch_set:
            try:
                d = datetime.strptime(d_str, "%Y-%m-%d")
            except Exception:
                continue
            if FY26_START <= d <= FY26_END:
                school_fy26[d.month].setdefault(d_str, []).append(s)
            elif FY27_START <= d <= FY27_END:
                school_fy27[d.month].setdefault(d_str, []).append(s)
        # Extreme weather
    ...
    for i, m in enumerate(fy_order):
        ...
        monthly.append({
            ...
            # School holiday days per month (unique calendar dates across states in filter).
            # `_count` = number of unique calendar dates in the month that are a school
            # holiday somewhere in the filter; `_detail` = list of {date, states}.
            'fy26_school_holiday_count': len(school_fy26[m]),
            'fy27_school_holiday_count': len(school_fy27[m]),
            'fy26_school_holiday_days': sorted(school_fy26[m].keys()),
            'fy27_school_holiday_days': sorted(school_fy27[m].keys()),
            'fy26_school_holiday_detail': [
                {'date': d, 'states': sorted(set(school_fy26[m][d]))}
                for d in sorted(school_fy26[m].keys())
            ],
            'fy27_school_holiday_detail': [
                {'date': d, 'states': sorted(set(school_fy27[m][d]))}
                for d in sorted(school_fy27[m].keys())
            ],
        })
...
def venues_detail():
    ...
    # /venues-detail shows servings-based growth metrics, so size LFL on servings
    lfl_multipliers, lfl_summary = _build_universal_lfl_multipliers(
        results, apply_guards, apply_cann, sales_type='servings'
    )
    ...
    for r in results:
        ...
        # Resolve sales: scenario override → cannibalisation + guardrails → universal LFL → venue-month adjustments
        ...
        sales, vma_note = _apply_venue_month_adjustments(r, sales)
        if vma_note:
            guardrail_note = (guardrail_note + ' | ' + vma_note) if guardrail_note else vma_note
        ...
        venue_rows.append({
            ...
            # School + public holiday metadata (carried through from forecast_venue)
            'school_holidays_loaded_count': r['servings'].get('school_holidays_loaded_count', 0),
            'school_holiday_count': r['servings'].get('school_holiday_count', 0),
            'holidays_loaded_count': r['servings'].get('holidays_loaded_count', 0),
        })
...
def data_sources():
    ...
    # School holidays summary — one entry per state with a non-empty range
    school_holiday_summary = {}
    for state in sorted(SCHOOL_HOLIDAY_RANGES.keys()):
        dates_set = load_school_holidays_for_state(state)
        if not dates_set:
            continue
        sorted_dates = sorted(dates_set)
        ranges = SCHOOL_HOLIDAY_RANGES.get(state, [])
        # First/last 3 period boundaries as examples
        examples = []
        for start, end in ranges[:3]:
            examples.append([start, end])
        examples_tail = []
        for start, end in ranges[-3:]:
            examples_tail.append([start, end])
        school_holiday_summary[state] = {
            'total_days': len(dates_set),
            'period_count': len(ranges),
            'min_date': sorted_dates[0] if sorted_dates else None,
            'max_date': sorted_dates[-1] if sorted_dates else None,
            'first_periods': examples,
            'last_periods': examples_tail,
        }
    return jsonify({
        'weather': weather_summary,
        'holidays': holiday_summary,
        'school_holidays': school_holiday_summary,
...
def _apply_baseline_guardrails(r):
    ...
    mature_lo = float(settings.get('mature_lo', 0.80))
    mature_hi = float(settings.get('mature_hi', 1.30))
    ramp_lo   = float(settings.get('ramp_lo',   0.75))
    ramp_hi   = float(settings.get('ramp_hi',   1.30))
    min_fy26_days = int(settings.get('min_fy26_days_to_guard', 30))
    # For ramping (partial FY26) venues, also cap on the recent run-rate to avoid
    # annualising a small base (e.g. Southbank: 2 months of FY26 trading → annualised
    # is misleading; cap on actual recent daily run-rate instead).
    run_rate_hi = float(settings.get('run_rate_hi', 1.20))   # multiplier on recent_30d × 365
    ...
    # Additional cap for ramping venues: cap on RECENT RUN RATE × 365 × run_rate_hi
    # This catches venues where annualising 2-3 months of partial trading gives a
    # misleadingly small base (e.g. Southbank opened Feb 2026 → annualised FY26 is
    # huge per day because we divide by 60 trading days; the recent run rate is the
    # real signal). The TIGHTER of the two ceilings wins.
    if kind == 'ramping' and fy26_days > 0:
        # Compute recent 60-day average from FY26 trades (most recent non-zero days)
        servings = SESSION_STATE.get('sales_servings') or {}
        recent_vals = []
        for d_str, v in (servings.get(venue) or {}).items():
            try:
                d = datetime.strptime(d_str, '%Y-%m-%d')
            except Exception:
                continue
            if FY26_START_DT <= d <= LAST_ACTUAL_DT and v and v > 0:
                recent_vals.append((d_str, v))
        recent_vals.sort(reverse=True)
        last_60 = [v for _, v in recent_vals[:60]]
        # Also incorporate completion-FC daily values
        for i, d_str in enumerate(r['forecast_dates']):
            try:
                d = datetime.strptime(d_str, '%Y-%m-%d')
            except Exception:
            ...
            if FY26_START_DT <= d <= FY26_END_DT and d > LAST_ACTUAL_DT and i < len(sales):
                ...
                if v and v > 0:
                    last_60.append(v)
        if last_60:
            recent_run_rate_annual = (sum(last_60) / len(last_60)) * 365.0
            run_rate_cap = recent_run_rate_annual * run_rate_hi
            hi_cap = min(hi_cap, run_rate_cap)
...
# ── PROPHET SOFTENING ─────────────────────────────────────────────────────────
@app.route("/softening/get", methods=["GET"])
def softening_get():
    return jsonify(SESSION_STATE.get('softening_settings') or {})


@app.route("/softening/set", methods=["POST"])
def softening_set():
    """Body: { enabled: bool, beta: float [0..1] }
       beta=1.0 → no softening; beta=0.5 → heavy softening.
    """
    body = request.get_json(silent=True) or {}
    beta = float(body.get('beta', 0.7) or 0.7)
    beta = max(0.0, min(1.0, beta))   # clamp
    SESSION_STATE['softening_settings'] = {
        'enabled': bool(body.get('enabled', True)),
        'beta': beta,
    }
    return jsonify({'status': 'ok', 'config': SESSION_STATE['softening_settings']})


def _apply_prophet_softening(r, sales):
    """Shrink Prophet's FY27 deviation from annualised FY26 baseline.
    Result = β × Prophet + (1-β) × (annualised FY26 per trading day).
    Applied as a UNIFORM level scalar so daily shape (seasonality, peaks, troughs)
    is preserved — only the LEVEL is pulled toward baseline.
    Returns (new_sales, note_or_None). No-op when softening disabled or β≈1.
    """
    cfg = SESSION_STATE.get('softening_settings') or {}
    ...
    try:
        ...
        beta = 0.7
    if beta >= 0.99:
        return sales, None   # essentially no softening

    venue = r['venue']
    servings_actual = SESSION_STATE.get('sales_servings') or {}

    # Build annualised FY26 per-trading-day baseline (excludes zero days)
    fy26 = 0.0
    fy26_days = 0
    for d_str, v in (servings_actual.get(venue) or {}).items():
        try:
    ...
    if fy26_days < 30 or fy26 <= 0:
        return sales, None   # too little data to anchor

    baseline_per_day = fy26 / fy26_days

    # Sum Prophet's FY27 prediction
    fy27_idx = []
    for i, d_str in enumerate(r['forecast_dates']):
        try:
            d = datetime.strptime(d_str, '%Y-%m-%d')
    ...
    prophet_avg = sum(sales[i] for i in fy27_idx) / len(fy27_idx)
    if prophet_avg <= 0:
        return sales, None

    # Blend the AVERAGE level, then scale each day by the same factor
    target_avg = beta * prophet_avg + (1 - beta) * baseline_per_day
    scale = target_avg / prophet_avg
    if abs(scale - 1.0) < 0.005:
        return sales, None   # nothing meaningful to shift

    new_sales = list(sales)
    for i in fy27_idx:
        new_sales[i] = sales[i] * scale

    pre_g = (prophet_avg - baseline_per_day) / baseline_per_day * 100
    post_g = (target_avg - baseline_per_day) / baseline_per_day * 100
    return new_sales, f"Softened Prophet (β={beta:.2f}): raw {pre_g:+.1f}% → {post_g:+.1f}% vs FY26 baseline"
...
def _resolve_venue_sales(r, apply_guardrails=True, apply_cannibalisation=True, apply_softening=True):
    """Return (sales_array, scenario_override, combined_note).
    Resolution priority (each step optional via flags):
      1. Active scenario override → user target wins, NO further adjustments
      2. Else:
         a. Prophet softening — shrink extreme deviations toward FY26 baseline
         b. Cannibalisation — apply impacts from venue_details
         c. Guardrails — cap to annualised FY26 band
    """
    ...
    # 1. Soften Prophet's extreme deviations from FY26 baseline (preserves shape)
    if apply_softening:
        soft_sales, soft_note = _apply_prophet_softening(r, sales)
        if soft_note:
            notes.append(soft_note)
            sales = soft_sales

    # 2. Cluster cannibalisation
    if apply_cannibalisation:
        # _apply_cluster_cannibalisation reads from r['servings']['sales'] directly,
        # so wrap with the post-softening sales if those changed.
        if sales is r['servings']['sales']:
            ...
            cann_sales, cann_note = _apply_cluster_cannibalisation(proxy)
        if cann_note:
            notes.append(cann_note)
            sales = cann_sales

    # 3. Guardrails (hard caps)
    if apply_guardrails:
        if sales is r['servings']['sales']:
...
def _build_universal_lfl_multipliers(results, apply_guards, apply_cann, sales_type='all'):
    """Pre-pass: compute monthly multipliers needed for the universal LFL target.
    The target is sized on the CURRENTLY VIEWED stream (sales_type) so the user
    sees exactly the target % they set on whichever view they're looking at.
    Multipliers are then applied uniformly to all 3 streams (so other streams
    move proportionally).

    sales_type: 'servings' | 'retail' | 'pos_discounts' | 'all'
    ...
    def _basis_value_actual(v_serv, v_ret, v_disc, d_str):
        """Value of the target basis for an actuals date."""
        if sales_type == 'servings':
            return v_serv.get(d_str) or 0
        if sales_type == 'retail':
            return v_ret.get(d_str) or 0
        if sales_type == 'pos_discounts':
            return -abs(v_disc.get(d_str) or 0)
        # 'all' = servings + retail − |discounts|
        return (v_serv.get(d_str) or 0) + (v_ret.get(d_str) or 0) - abs(v_disc.get(d_str) or 0)

    def _basis_value_forecast(s_v, r_v, d_v):
        """Value of the target basis for a forecast day. d_v is already negated."""
        if sales_type == 'servings':
            return s_v
        if sales_type == 'retail':
            return r_v
    ...
    for r in results:
        ...
        # FY26 actuals (Jul-Apr 2026) — basis depends on sales_type
        ...
        for d_str in all_dates:
            ...
            if FY26_START_DT <= d <= LAST_ACTUAL_DT:
                basis_v = _basis_value_actual(v_serv, v_ret, v_disc, d_str)
                if basis_v:
                    lfl_fy26_monthly[d.month] += basis_v

        # Resolved FY26 completion + FY27 sales
...
def _apply_venue_month_adjustments(r, sales):
    """Single-stream variant — apply per-venue per-month adjustments (view-time scenario overlay).
    Returns (new_sales, note_or_None).
    """
    new_sales = list(sales)
    venue = r.get('venue', '')
    adjustments = SESSION_STATE.get('venue_month_adjustments', {}).get(venue, {})

    if not adjustments:
        return new_sales, None
    ...
    for i, d_str in enumerate(r['forecast_dates']):
        ...
        # Only apply to FY27 (Jul 2026 - Jun 2027)
        if not (FY27_START_DT <= d <= FY27_END_DT):
            continue

        year_month = d.strftime('%Y-%m')
        if year_month not in adjustments:
            continue

        adj = adjustments[year_month]
        adj_type = adj.get('adjustment_type', 'growth')
        adj_pct = adj.get('value_pct', 0.0)

        multiplier = 1.0 + (adj_pct / 100.0)

        if i < len(new_sales):
            new_sales[i] = new_sales[i] * multiplier

        touched_days += 1
        touched_months.add(year_month)

    if touched_days == 0:
        return new_sales, None

    return new_sales, f"Venue-month adjustments applied to {len(touched_months)} months ({touched_days} days)"
...
def _apply_venue_month_adjustments_streams(r, *streams):
    """Apply per-venue per-month adjustments (growth override or cannibalisation delta).
    Adjustments are applied to FY27 dates only.

    growth: replaces the month's growth with a specific percentage
    cannibalisation: adds/subtracts from the month's growth (e.g., 5% + -10% = -5%)

    Returns (list_of_new_arrays, note_or_None).
    """
    new_streams = [list(s) for s in streams]
    venue = r.get('venue', '')
    adjustments = SESSION_STATE.get('venue_month_adjustments', {}).get(venue, {})
    ...
    for i, d_str in enumerate(r['forecast_dates']):
        ...
        if adj_type == 'growth':
            # Growth mode: replace the month's growth with the specified percentage
            # Multiplier = 1.0 + (adj_pct / 100.0)
            multiplier = 1.0 + (adj_pct / 100.0)
        else:
            # Cannibalisation mode: add/subtract from the growth
            # Multiplier = 1.0 + (adj_pct / 100.0)
            multiplier = 1.0 + (adj_pct / 100.0)
    ...
    return new_streams, f"Venue-month adjustments applied to {len(touched_months)} months ({touched_days} days)"


@app.route("/venue-month-adjustment/get", methods=["GET"])
def venue_month_adjustment_get():
    """Get all venue-month adjustments (view-time scenario overlay).
    Returns: { venue_name: { 'YYYY-MM': { 'adjustment_type': 'growth'|'cannibalisation', 'value_pct': float } } }
    """
    return jsonify(SESSION_STATE.get('venue_month_adjustments') or {})


@app.route("/venue-month-adjustment/set", methods=["POST"])
def venue_month_adjustment_set():
    """Create or update a venue-month adjustment.
    Body: {
      venue: "Yo-Chi Albert St",
      year_month: "2026-09",
      adjustment_type: "growth" | "cannibalisation",
      value_pct: <float>
    }
    - growth: replaces the month's LFL with the specified percentage
    - cannibalisation: adds/subtracts from the month's LFL (e.g., 5% + -10% = -5%)
    ...
    year_month = (body.get('year_month') or '').strip()
    adjustment_type = (body.get('adjustment_type') or '').strip()
    value_pct = body.get('value_pct', 0.0)

    if not venue or not year_month or adjustment_type not in ('growth', 'cannibalisation'):
        return jsonify({'error': 'Missing/invalid: venue, year_month, adjustment_type'}), 400

    if venue not in SESSION_STATE.get('venue_month_adjustments', {}):
        SESSION_STATE['venue_month_adjustments'][venue] = {}

    SESSION_STATE['venue_month_adjustments'][venue][year_month] = {
        'adjustment_type': adjustment_type,
        'value_pct': float(value_pct),
    }
    return jsonify({'status': 'ok', 'adjustments': SESSION_STATE['venue_month_adjustments']})


@app.route("/venue-month-adjustment/delete", methods=["POST"])
def venue_month_adjustment_delete():
    """Delete a specific venue-month adjustment.
    Body: { venue: "...", year_month: "2026-09" }
    """
    body = request.get_json(silent=True) or {}
    venue = (body.get('venue') or '').strip()
    year_month = (body.get('year_month') or '').strip()

    if not venue or not year_month:
        return jsonify({'error': 'Missing: venue or year_month'}), 400

    if venue in SESSION_STATE.get('venue_month_adjustments', {}) and year_month in SESSION_STATE['venue_month_adjustments'][venue]:
        del SESSION_STATE['venue_month_adjustments'][venue][year_month]
        if not SESSION_STATE['venue_month_adjustments'][venue]:
            del SESSION_STATE['venue_month_adjustments'][venue]
...
def _pnl_compute(state='all', cluster='all', cohort='all', venue_q='all', apply_guards=True, apply_cann=True):
    ...
    # /pnl shows net revenue, so size LFL on 'all' (net = servings + retail − |discounts|)
    lfl_multipliers, lfl_summary = _build_universal_lfl_multipliers(
        results, apply_guards, apply_cann, sales_type='all'
    )

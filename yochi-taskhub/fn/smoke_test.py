...
DB_PROBES = {
    ...
    "corpus_health": "id,checked_at,mirror_phase,mirror_files,mirror_updated,mirror_age_days,indexed_docs,index_parts,index_updated,index_age_days,coverage_pct,indexed_gain,status,problems",
